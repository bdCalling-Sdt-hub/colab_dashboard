...
const UpdateAuctionModal = ({ isModalOpen, setIsModalOpen, singleAuction }) => {
  ...
  const [isFinancingAvailable, setIsFinancingAvailable] = useState(
    singleAuction?.financeAvailable
  );
        ...
        <Form form={form} onFinish={onFinish} layout="vertical">
          ...
          <div className="flex justify-between items-center gap-2">
            <Form.Item
              ...
              className="w-full"
              rules={[
                { required: true, message: "Please input reserved bid!" },
              ]}
            >
              <Input type="number" />
            </Form.Item>
            <Form.Item
              ...
              className="w-full"
              rules={[
                { required: true, message: "Please input increment value!" },
              ]}
            >
              <Input type="number" />
            </Form.Item>
          ...
          >
            ...
            {/* Months Input */}
            <div>
              <Form.Item label="Month" name="totalMonthForFinance">
                <Input
