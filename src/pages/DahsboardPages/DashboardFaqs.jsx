    ...
    <div className="bg-white rounded-md p-5">
      ...
      <div className="flex items-center justify-center mt-20">
        <button
          ...
          className="flex items-center gap-2 bg-yellow text-white px-10 py-2 rounded-3xl"
        >
          <GoPlus size={20} />
          <span> Add FAQ</span>
        </button>
      ...
      >
        ...
        <Form onFinish={onFinish} form={form} onCancel={form.resetFields()}>
          ...
          <div className="flex items-center justify-center mt-2">
            <button className="flex w-full items-center justify-center gap-2 bg-yellow text-white px-10 py-2 text-xl rounded-3xl">
              {" "}
              Save
            </button>
          </div>
