...
const Transaction = () => {
  ...
  const { data: transactions, isLoading } = useGetAllTransactionQuery({
    ...
    page: currentPage,
    limit: pageSize,
    ...(transactionType !== null && transactionType !== undefined ? { transactionType } : {}),
  });
      ...
      render: (_, record) => {
        return (
          <div className="flex items-center gap-2">
            <img src={record?.img} className="w-[40px] h-[40px] rounded-[8px]" alt="" />
    ...
    <div className="bg-[#323232] rounded-md p-5">
      <div className="flex justify-between item-center mb-5">
        <div className="flex items-center gap-2">
          ...
          <span className="font-semibold text-white text-[20px]">Transaction</span>
        </div>
        <div>
          <Select
          ...
          >
            ...
            <Select.Option value={"Purchase Subscription"}>Purchase Subscription</Select.Option>
            <Select.Option value={"Renew Subscription"}>Renew Subscription</Select.Option>
            <Select.Option value={"Collaboration"}>Collaboration Payment</Select.Option>
          </Select>
        </div>
      </div>
      <div className="mt-2 ">
