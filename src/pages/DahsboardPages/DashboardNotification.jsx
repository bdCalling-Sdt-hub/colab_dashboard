  ...
  return (
    <div>
      <div className="flex justify-between items-center gap-4 text-white">
        <h3 className="text-white text-[20px] font-semibold flex items-center gap-2">
          <Link to={-1}>
            {" "}
      ...
      <div>
        <div className="flex  items-center justify-between text-white">
          <h2 className="text-[18px] font-semibold py-2">
            Total {newNotifications} Notifications
          </h2>
          <p
            className="mr-2 cursor-pointer hover:border-b hover:border-gray hover:text-gray"
        ...
        <Table
          columns={columns}
          dataSource={formattedTableData?.reverse()}
          pagination={false}
